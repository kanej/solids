...
goog.require("goog.graphics.CanvasGraphics");
goog.require("goog.dom");
solids.purple_fill = new goog.graphics.SolidFill("#66b", 0.4);
solids.purple_stroke = new goog.graphics.Stroke(4, "#66b");
solids.draw_line = function draw_line(canvas, p__55286) {
  var vec__55290 = p__55286;
  var vec__55291 = cljs.core.nth.call(null, vec__55290, 0, null);
  var x1 = cljs.core.nth.call(null, vec__55291, 0, null);
  var y1 = cljs.core.nth.call(null, vec__55291, 1, null);
  var vec__55292 = cljs.core.nth.call(null, vec__55290, 1, null);
  var x2 = cljs.core.nth.call(null, vec__55292, 0, null);
  var y2 = cljs.core.nth.call(null, vec__55292, 1, null);
  var line = vec__55290;
  var path = (new goog.graphics.Path).moveTo(100 + x1, 100 + y1).lineTo(100 + x2, 100 + y2);
  canvas.drawPath(path, solids.purple_stroke, null);
  return canvas
};
solids.draw_lines = function draw_lines(canvas, lines) {
  var seq__55297 = cljs.core.seq.call(null, lines);
  var chunk__55298 = null;
  var count__55299 = 0;
  var i__55300 = 0;
  while(true) {
    if(i__55300 < count__55299) {
      var line = cljs.core._nth.call(null, chunk__55298, i__55300);
      solids.draw_line.call(null, canvas, line);
      var G__55301 = seq__55297;
      var G__55302 = chunk__55298;
      var G__55303 = count__55299;
      var G__55304 = i__55300 + 1;
      seq__55297 = G__55301;
      chunk__55298 = G__55302;
      count__55299 = G__55303;
      i__55300 = G__55304;
      continue
    }else {
      var temp__4092__auto__ = cljs.core.seq.call(null, seq__55297);
      if(temp__4092__auto__) {
        var seq__55297__$1 = temp__4092__auto__;
        if(cljs.core.chunked_seq_QMARK_.call(null, seq__55297__$1)) {
          var c__3073__auto__ = cljs.core.chunk_first.call(null, seq__55297__$1);
          var G__55305 = cljs.core.chunk_rest.call(null, seq__55297__$1);
          var G__55306 = c__3073__auto__;
          var G__55307 = cljs.core.count.call(null, c__3073__auto__);
          var G__55308 = 0;
          seq__55297 = G__55305;
          chunk__55298 = G__55306;
          count__55299 = G__55307;
          i__55300 = G__55308;
          continue
        }else {
          var line = cljs.core.first.call(null, seq__55297__$1);
          solids.draw_line.call(null, canvas, line);
          var G__55309 = cljs.core.next.call(null, seq__55297__$1);
          var G__55310 = null;
          var G__55311 = 0;
          var G__55312 = 0;
          seq__55297 = G__55309;
          chunk__55298 = G__55310;
          count__55299 = G__55311;
          i__55300 = G__55312;
          continue
        }
      }else {
...
solids.sqr = function sqr(x) {
  return x * x
};
solids.distance_between = function distance_between(p__55313, p__55314) {
  var vec__55317 = p__55313;
  var x1 = cljs.core.nth.call(null, vec__55317, 0, null);
  var y1 = cljs.core.nth.call(null, vec__55317, 1, null);
  var vec__55318 = p__55314;
  var x2 = cljs.core.nth.call(null, vec__55318, 0, null);
  var y2 = cljs.core.nth.call(null, vec__55318, 1, null);
  return Math.sqrt.call(null, solids.sqr.call(null, x2 - x1) + solids.sqr.call(null, y2 - y1))
};
solids.transform = function transform(p__55319, p__55320) {
  var vec__55323 = p__55319;
  var x = cljs.core.nth.call(null, vec__55323, 0, null);
  var y = cljs.core.nth.call(null, vec__55323, 1, null);
  var vec__55324 = p__55320;
  var x_offset = cljs.core.nth.call(null, vec__55324, 0, null);
  var y_offset = cljs.core.nth.call(null, vec__55324, 1, null);
  return cljs.core.PersistentVector.fromArray([x + x_offset, y + y_offset], true)
};
solids.make_cube = function make_cube(p__55325, p__55326) {
  var vec__55329 = p__55325;
  var x1 = cljs.core.nth.call(null, vec__55329, 0, null);
  var y1 = cljs.core.nth.call(null, vec__55329, 1, null);
  var p1 = vec__55329;
  var vec__55330 = p__55326;
  var x2 = cljs.core.nth.call(null, vec__55330, 0, null);
  var y2 = cljs.core.nth.call(null, vec__55330, 1, null);
  var p2 = vec__55330;
  var length = solids.distance_between.call(null, p1, p2);
  var p3 = solids.transform.call(null, p1, cljs.core.PersistentVector.fromArray([length, length], true));
  var p4 = solids.transform.call(null, p1, cljs.core.PersistentVector.fromArray([0, length], true));
  var p5 = solids.transform.call(null, p1, cljs.core.PersistentVector.fromArray([40, -40], true));
  var p6 = solids.transform.call(null, p5, cljs.core.PersistentVector.fromArray([length, 0], true));
  var p7 = solids.transform.call(null, p5, cljs.core.PersistentVector.fromArray([length, length], true));
  var p8 = solids.transform.call(null, p5, cljs.core.PersistentVector.fromArray([0, length], true));
  return cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray([p1, p2], true), cljs.core.PersistentVector.fromArray([p2, p3], true), cljs.core.PersistentVector.fromArray([p3, p4], true), cljs.core.PersistentVector.fromArray([p4, p1], true), cljs.core.PersistentVector.fromArray([p5, p6], true), cljs.core.PersistentVector.fromArray([p6, p7], true), cljs.core.PersistentVector.fromArray([p7, p8], true), cljs.core.PersistentVector.fromArray([p8, p5], true), cljs.core.PersistentVector.fromArray([p1, 
  p5], true), cljs.core.PersistentVector.fromArray([p2, p6], true), cljs.core.PersistentVector.fromArray([p3, p7], true), cljs.core.PersistentVector.fromArray([p4, p8], true)], true)
};
solids.main = function main() {
  var cube_element = goog.dom.getElement("cube");
  var cube_lines = solids.make_cube.call(null, cljs.core.PersistentVector.fromArray([0, 0], true), cljs.core.PersistentVector.fromArray([100, 0], true));
  var G__55332 = goog.graphics.createGraphics(600, 400);
  solids.draw_lines.call(null, G__55332, cube_lines);
  G__55332.render(goog.dom.getElement("cube"));
  return G__55332
};
